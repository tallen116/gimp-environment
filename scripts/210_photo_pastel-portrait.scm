...
(define (210-pastel-portrait
  ...
  (let* (
	...
	(gimp-image-add-layer img layer-orig -1)
...
(script-fu-menu-register "210-pastel-portrait" "<Image>/Script-Fu/Photo/")