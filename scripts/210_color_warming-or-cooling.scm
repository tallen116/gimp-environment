; 210_color_warming-or-cooling.scm
...
(define (tone-adjust 
   ...
   (let* ( 
		...
		(cond ((or (< tone 4)(= tone 6))
			...
			(gimp-edit-bucket-fill-full overlay-layer BG-BUCKET-FILL LAYER-MODE-NORMAL-LEGACY 100 255 FALSE FALSE SELECT-CRITERION-COMPOSITE 0 0)
