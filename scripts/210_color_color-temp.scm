...
(script-fu-register "210-colortemp"
	"<Image>/Script-Fu/Color/Color Temp"
	"This script-fu converts the color temperature of an image.  You can specify the color temperature of the original image."
