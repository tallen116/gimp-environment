...
(define (210-calendar-month image drawable lang month year sunday? letters-in-day layout text-font number-font fontsize% justify? border border-color gravity)
...
(define (210-calendar-year orig-image orig-drawable 
                                    lang 
                                    year 
                                    num-cols 
                                    padding
    ...
    (let* ((num-cols (truncate num-cols))
      ...
      (while (pair? y-offsets)
        ...
        (while (and (pair? x-offsets) (< month 12))
          ...
          (gimp-buffer-delete buffer)
          (210-calendar-month image temp-layer lang month year sunday? 
...
(script-fu-register "210-calendar-month"
  "<Image>/Script-Fu/Calendar Month"
  ...
  SF-ADJUSTMENT "Year" '( 2018 1753 2050 1 10 0 1 )
...
(script-fu-register "210-calendar-year"
  "<Image>/Script-Fu/Calendar Year"
